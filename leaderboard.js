...
(function () {
  ...
  function showSubmitOverlay(finalScore) {
    ...
    // Block all game input for the duration of the overlay
    ...
    // Keep keyboard capture disabled whenever focus is on the input
    // (disableForTextInput is already called above, these handle re-focus edge cases)
